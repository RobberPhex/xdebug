...
#define XDEBUG_CMD_ERROR          -1
#define XDEBUG_CMD_OK             0
#define XDEBUG_CMD_CONT           1
#define XDEBUG_CMD_BREAK          2
...
#define RETURN_RESULT(s, r, c) { \
	...
	return (c) == XDEBUG_ERROR_OK ? XDEBUG_CMD_OK : XDEBUG_CMD_ERROR; \
}
...
#define DBGP_FUNC(name)             static int xdebug_dbgp_handle_##name(DBGP_FUNC_PARAMETERS)
